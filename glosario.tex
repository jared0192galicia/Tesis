...
\newglossaryentry{framework}{
    ...
    description={Un conjunto estandarizado de conceptos, prácticas y criterios para enfocar un tipo de problemática particular, que sirve como referencia para enfrentar y resolver nuevos problemas de índole similar. A diferencia de una biblioteca, el framework controla el flujo de la ejecución (inversión de control). \cite{ibm_framework}}
}
